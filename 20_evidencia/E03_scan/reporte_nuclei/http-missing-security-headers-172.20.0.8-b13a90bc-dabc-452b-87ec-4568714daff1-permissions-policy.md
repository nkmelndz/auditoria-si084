### HTTP Missing Security Headers (http-missing-security-headers:permissions-policy) found on 172.20.0.8

----
**Details**: **http-missing-security-headers:permissions-policy** matched at 172.20.0.8
