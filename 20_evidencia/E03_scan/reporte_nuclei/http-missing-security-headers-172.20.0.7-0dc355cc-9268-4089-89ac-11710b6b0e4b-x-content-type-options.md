### HTTP Missing Security Headers (http-missing-security-headers:x-content-type-options) found on 172.20.0.7

----
**Details**: **http-missing-security-headers:x-content-type-options** matched at 172.20.0.7
