### WordPress Exposed Installation (wp-install) found on 172.20.0.7

----
**Details**: **wp-install** matched at 172.20.0.7

**Protocol**: HTTP

**Full URL**: http://172.20.0.7/wp-admin/install.php?step=1

**Timestamp**: Thu Sep 3 05:42:48 +0000 UTC 2026
...
| Authors | princechaddha, 0xpugal |
| Tags | misconfig, panel, wordpress, vuln |
| Severity | critical |
| Description | Wordpress installation files have been detected |
| CVSS-Metrics | [CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:H/A:H](https://www.first.org/cvss/calculator/3.1#CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:H/A:H) |
		...
		<tr>
			...
			<td>
				<div class="wp-pwd">
						...
						<input type="password" name="admin_password" id="pass1" class="regular-text" autocomplete="new-password" spellcheck="false" data-reveal="1" data-pw="4BV)rqdkoStVy(Emuh" aria-describedby="pass-strength-result admin-password-desc" />
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'User-Agent: Mozilla/5.0 (Windows NT 6.2; rv:140.) Gecko/20100101 Firefox/140.' 'http://172.20.0.7/wp-admin/install.php?step=1'
```
