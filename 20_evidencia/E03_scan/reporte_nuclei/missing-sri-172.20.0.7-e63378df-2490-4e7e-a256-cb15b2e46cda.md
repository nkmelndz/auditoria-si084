### Missing Subresource Integrity (missing-sri) found on 172.20.0.7

----
**Details**: **missing-sri** matched at 172.20.0.7

**Protocol**: HTTP

**Full URL**: http://172.20.0.7/wp-admin/install.php

**Timestamp**: Thu Sep 3 05:41:52 +0000 UTC 2026
...
| Authors | lucky0x0d, pulsesecurity.co.nz, sullo amarsct |
| Tags | compliance, js, css, sri, misconfig, vuln |
| Severity | info |
| Description | Checks if external script and stylesheet tags in the HTML response are missing the Subresource Integrity (SRI) attribute.<br> |
...
Date: Thu, 03 Sep 2026 05:41:50 GMT
...
- http://172.20.0.7/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.1
- http://172.20.0.7/wp-admin/js/language-chooser.min.js?ver=7.1
- http://172.20.0.7/wp-includes/js/jquery/jquery.min.js?ver=3.7.1
- http://172.20.0.7/wp-admin/css/l10n.min.css?ver=7.1
- http://172.20.0.7/wp-includes/css/dist/base-styles/admin-schemes.min.css?ver=7.1
- http://172.20.0.7/wp-admin/css/install.min.css?ver=7.1
- http://172.20.0.7/wp-includes/css/dashicons.min.css?ver=7.1
- http://172.20.0.7/wp-includes/css/buttons.min.css?ver=7.1
- http://172.20.0.7/wp-admin/css/forms.min.css?ver=7.1
...
**CURL command**
```sh
curl -X 'GET' -d '' -H 'Accept: */*' -H 'Accept-Language: en' -H 'Referer: http://172.20.0.7/' -H 'User-Agent: Mozilla/5.0 (Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36' 'http://172.20.0.7/wp-admin/install.php'
```
