### HTTP Missing Security Headers (http-missing-security-headers:x-frame-options) found on 172.20.0.6

----
**Details**: **http-missing-security-headers:x-frame-options** matched at 172.20.0.6
